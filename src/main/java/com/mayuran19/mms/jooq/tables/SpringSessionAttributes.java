...
import com.mayuran19.mms.jooq.tables.SpringSession.SpringSessionPath;
...
public class SpringSessionAttributes extends TableImpl<SpringSessionAttributesRecord> {
    ...
    public UniqueKey<SpringSessionAttributesRecord> getPrimaryKey() {
        return Keys.PK_SPRING_SESSION_ATTRIBUTES;
    }

    @Override
    public List<ForeignKey<SpringSessionAttributesRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SPRING_SESSION_ATTRIBUTES__FK_SPRING_SESSION_ATTRIBUTES_SESSION);
    }
    ...
    public SpringSessionPath springSession() {
        if (_springSession == null)
            _springSession = new SpringSessionPath(this, Keys.SPRING_SESSION_ATTRIBUTES__FK_SPRING_SESSION_ATTRIBUTES_SESSION, null);
